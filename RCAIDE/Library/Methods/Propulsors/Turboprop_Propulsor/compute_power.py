...
def compute_power(turboprop,conditions,throttle = 1.0):
    ...
    turboprop.conversion_efficiency           [-]
    ...
    #total_pressure_reference                   = turboprop.inputs.total_pressure_reference                                                             # Source [1]
    #eta_c                                      = turboprop.conversion_efficiency                                                                       # Source [2]
                                                                                                                                                        
    ##unpacking from turboprop                                                                                                                          
    #Tref                                       = turboprop.reference_temperature                                                                       # Source [1]
    #Pref                                       = turboprop.reference_pressure                                                                          # Source [1]
    #Tt4                                        = turboprop.combustor.outputs.stagnation_temperature                                                    
    #pi_c                                       = turboprop.compressor.pressure_ratio                                                                   
    #m_dot_compressor                           = turboprop.compressor.mass_flow_rate                                                                   # Source [2]
    ...
    ##pack outputs
    #turboprop.outputs.power_specific_fuel_consumption   = PSFC
    #turboprop.outputs.fuel_flow_rate                    = fuel_flow_rate                                                                              
    #turboprop.outputs.power                             = Power
    #turboprop.outputs.non_dimensional_power             = Psp
    #turboprop.outputs.non_dimensional_thrust            = Tsp
    #turboprop.outputs.thermal_efficiency                = eta_T

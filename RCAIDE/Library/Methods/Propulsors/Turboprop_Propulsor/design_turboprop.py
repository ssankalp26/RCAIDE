...
from RCAIDE.Library.Methods.Propulsors.Turboshaft_Propulsor.compute_turboprop_performance   import   compute_performance
...
def design_turboprop(turboprop):  
    ...
    #turboprop.inputs.stag_temp_lpt_exit                  = compressor.inputs.stagnation_temperature
    #turboprop.inputs.stag_press_lpt_exit                 = compressor.inputs.stagnation_pressure 
    ...
    ##compute the power
    #turboprop.inputs.fan_nozzle                          = Data()
    #turboprop.inputs.fan_nozzle.velocity                 = 0.0
    #turboprop.inputs.fan_nozzle.area_ratio               = 0.0
    #turboprop.inputs.fan_nozzle.static_pressure          = 0.0
    #turboprop.inputs.bypass_ratio                        = 0.0
    #turboprop.inputs.flow_through_core                   = 1.0 #scaled constant to turn on core power computation
    #turboprop.inputs.flow_through_fan                    = 0.0 #scaled constant to turn on fan power computation      

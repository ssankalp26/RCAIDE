...
class Turboprop_Engine_Network(Network):
    ...
    def evaluate_power(self,state):
        ...
        for fuel_line in fuel_lines:
            if fuel_line.active:   
                ...
                fuel_line_T,fuel_line_P = compute_turboprop_performance(fuel_line,state)  
    ...
    def unpack_unknowns(self,segment):
        ...
        fuel_lines = segment.analyses.energy.networks.turboprop_engine.fuel_lines
